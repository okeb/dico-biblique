<div class="py-12">
    <h1 class=" sans-serif text-gray-600 font-bold text-5xl text-center">
        Vous avez une préoccupation
    </h1>
    <div class="container my-24 mx-12">
        <section class="text-gray-800  gap-6">
            ...
            <div class="grow-0 shrink-0 basis-auto w-full md:md:w-5/12 px-3 lg:px-6 pt-12">
